...
\begin{table}[!htbp]
    ...
    \begin{tabular}{lccc}
        ...
        rosso        &  3.137   &   2.10$\cdot$10$^{-6}$  & 0.001 \\%&  0                    &   0     & 0.001\\
        \hline
    \end{tabular}
    \par}
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot[color=blue, domain=0.0000020:0.0000055]{3.01292+x*59237.22405};
...
\begin{align*}
    &b = (5.9 \pm 0.1) \cdot 10^4 \text{ nm$^2$} \\
    &a = (3.0 \pm 0.0)
\end{align*}
...
\begin{align*}
    ...
    &\tilde{\chi}^2= 1.5 \\
\end{align*}
che corrisponde ad una probabilità del 21\%, a significare che la distribuzione osservata e' descrivibile con la relazione di Cauchy.
